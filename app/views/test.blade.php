...
<!-- Mirrored from htmlstream.com/preview/unify-v1.6-production/feature_box_general.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Dec 2014 01:32:11 GMT -->
<head>
...
<div class="wrapper">
                                            ...
                                            <div class="row equal-height">
                                                ...
                                                <div class="col-md-3 equal-height-in">
                                                    <ul class="list-unstyled equal-height-list">
                                                        ...
                                                        <!-- Content Boxes -->
                                                        <li class="active"><a href="feature_box_general.html"><i class="fa fa-cog"></i> General Content Boxes</a></li>
    ...
    <div class="breadcrumbs">
        <div class="container">
            <h1 class="pull-left">General Content Boxes</h1>
            <ul class="pull-right breadcrumb">
                <li><a href="index-2.html">Home</a></li>
                <li><a href="#">Features</a></li>
                <li class="active">Content Boxes</li>
            </ul>
        </div>
    </div><!--/breadcrumbs-->
    <!--=== End Breadcrumbs ===-->
        ...
        <div class="row">
                ...
                <ul class="list-group sidebar-nav-v1 fa-fixed" id="sidebar-nav">
                    ...
                    <li class="list-group-item list-toggle">                   
                        ...
                        <ul id="collapse-typography" class="collapse">
                            ...
                            <li><a href="feature_typo_testimonials.html"><i class="fa fa-comments"></i> Testimonials</a></li>                            
                            <li><a href="feature_typo_tagline_boxes.html"><i class="fa fa-tasks"></i> Tagline Boxes</a></li>
                            <li><a href="feature_typo_grid.html"><i class="fa fa-align-justify"></i> Grid Layout</a></li>
                        </ul>
                    </li>
                    <!-- End Typography -->
                    ...
                    <li class="list-group-item list-toggle">                   
                        ...
                        <ul id="collapse-buttons" class="collapse">
                            ...
                            <li>
                                <span class="badge badge-u">New</span>                            
                                <a href="feature_btn_brands.html"><i class="fa fa-html5"></i> Brand &amp; Social Buttons</a>
                            </li>
                            <li>
                                <span class="badge badge-u">New</span>                            
                                <a href="feature_btn_effects.html"><i class="fa fa-bolt"></i> Loading &amp; Hover Effects</a>
                            </li>
                        </ul>
                    </li>
                    <!-- End Buttons UI -->
                    ...
                    <li class="list-group-item list-toggle">                   
                        ...
                        <ul id="collapse-icons" class="collapse">
                            <li>
                                <span class="badge badge-u">New</span>                            
                                <a href="feature_icon_general.html"><i class="fa fa-chevron-circle-right"></i> General Icons</a>
                            </li>
                            <li><a href="feature_icon_fa.html"><i class="fa fa-chevron-circle-right"></i> Font Awesome Icons</a></li>
                            <li>
                                <span class="badge badge-u">New</span>                            
                                <a href="feature_icon_line.html"><i class="fa fa-chevron-circle-right"></i> Line Icons</a>
                            </li>
                            <li><a href="feature_icon_glyph.html"><i class="fa fa-chevron-circle-right"></i> Glyphicons (Bootstrap)</a></li>
                            <li><a href="feature_icon_glyph_pro.html"><i class="fa fa-chevron-circle-right"></i> Glyphicons Pro Icons</a></li>
                        </ul>
                    </li>
                    <!-- End Icons -->
                    ...
                    <li class="list-group-item list-toggle active">                   
                        ...
                        <ul id="collapse-content-boxes" class="collapse in">
                            <li class="active">
                                <span class="badge badge-u">New</span>                            
                                <a href="feature_box_general.html"><i class="fa fa-cog"></i> General Content Boxes</a>
                            </li>
                            <li><a href="feature_box_colored.html"><i class="fa fa-align-center"></i> Colored Boxes</a></li>
                            <li><a href="feature_box_funny.html"><i class="fa fa-bars"></i> Funny Boxes</a></li>
                        </ul>
                    ...
                    <li class="list-group-item list-toggle">
                        ...
                        <ul id="collapse-components" class="collapse">
                            ...
                            <li>
                                <span class="badge badge-u">New</span>                            
                                <a href="feature_compo_labels.html"><i class="fa fa-tags"></i> Labels &amp; Badges</a>
                            </li>
                            <li>
                                <span class="badge badge-u">New</span>                            
                                <a href="feature_compo_progress_bars.html"><i class="fa fa-align-left"></i> Progress Bars</a>
                            </li>
                            <li>
                                <span class="badge badge-u">New</span>
                                <a href="feature_compo_media.html"><i class="fa fa-volume-down"></i> Audio/Videos &amp; Images</a>
                            </li>
                            <li><a href="feature_compo_panels.html"><i class="fa fa-columns"></i> Panels</a></li>
                            <li><a href="feature_compo_pagination.html"><i class="fa fa-arrows-h"></i> Pagination</a></li>
                        </ul>
                    </li>
                    <!-- End Components -->

                    <!-- Accordion and Tabs -->
                    <li class="list-group-item"><a href="feature_accordion_and_tabs.html">Accordion and Tabs</a></li>
                    ...
                    <li class="list-group-item list-toggle">                   
                        ...
                        <ul id="collapse-timeline" class="collapse">
                            <li>
                                <span class="badge badge-u">New</span>                            
                                <a href="feature_timeline1.html"><i class="fa fa-dot-circle-o"></i> Timeline 1</a>
                            </li>
                            <li>
                                <span class="badge badge-u">New</span>                            
                                <a href="feature_timeline2.html"><i class="fa fa-dot-circle-o"></i> Timeline 2</a>
                            </li>
                        </ul>
                    </li>
                    <!-- End Timeline -->                    
                    ...
                    <li class="list-group-item">
                        <span class="badge badge-u">New</span>                    
                        <a href="feature_carousels.html">Carousel Exampls</a>
                    </li>
                    ...
                    <li class="list-group-item list-toggle">
                        ...
                        <ul id="collapse-forms" class="collapse">
                            ...
                            <li>
                                <span class="badge badge-u">New</span>                            
                                <a href="feature_form_general1.html"><i class="fa fa-bars"></i> General Unify Forms</a>
                            </li>
                            <li>
                                <span class="badge badge-u">New</span>                            
                                <a href="feature_form_advanced.html"><i class="fa fa-bars"></i> Advanced Forms</a>
                            </li>
                            <li>
                                <span class="badge badge-u">New</span>                            
                                <a href="feature_form_layouts.html"><i class="fa fa-bars"></i> Form Layouts</a>
                            </li>                            
                            <li>
                                <span class="badge badge-u">New</span>                            
                                <a href="feature_form_layouts_advanced.html"><i class="fa fa-bars"></i> Advanced Form Layouts</a>
                            </li>
                            <li>
                                <span class="badge badge-u">New</span>                            
                                <a href="feature_form_states.html"><i class="fa fa-bars"></i> Form States</a>
                            </li>
                            <li>
                                <span class="badge badge-u">New</span>                            
                                <a href="feature_form_sliders.html"><i class="fa fa-bars"></i> Form Sliders</a>
                            </li>
                            <li>
                                <span class="badge badge-u">New</span>                            
                                <a href="feature_form_modals.html"><i class="fa fa-bars"></i> Modals</a>
                            </li>
                        </ul>
                    </li>
                    <!-- End Forms -->
                    ...
                    <!-- Tables -->
                    <li class="list-group-item"><a href="feature_table_general.html">Tables</a></li>
                    <!-- End Tables -->
                    ...
                    <li class="list-group-item list-toggle">                   
                        ...
                        <ul id="collapse-maps" class="collapse">
                            <li>
                                <span class="badge badge-u">New</span>
                                <a href="feature_maps_google.html"><i class="fa fa-map-marker"></i> Google Maps</a>
                            </li>
                            <li>
                                <span class="badge badge-u">New</span>                            
                                <a href="feature_maps_vector.html"><i class="fa fa-align-center"></i> Vector Maps</a>
                            </li>
                        </ul>
                    </li>
                    <!-- End Maps -->                    
                    ...
                    <li class="list-group-item">
                        <span class="badge badge-u">New</span>                    
                        <a href="feature_compo_charts.html">Charts &amp; Countdowns</a>
                    </li>
                    <!-- End Charts -->
                </ul>
            </div>
            ...
            <div class="col-md-9">
                <div class="alert alert-info fade in margin-bottom-40">
                    ...
                    <strong>Creat Unlimited Styles!</strong> You are able to use more than 600 icons from <a class="alert-link" href="feature_icon_fa.html">Font Awesome Icons</a> and <a class="alert-link" href="feature_icon_line.html">Line Icons</a>
                </div>            
                ...
                <div class="row content-boxes-v2 margin-bottom-30">
                    ...
                    <div class="col-md-4">
                        <h2 class="heading-sm">
                            <i class="icon-custom icon-sm icon-bg-red icon-line icon-rocket"></i>
                            <span>Small Icons</span>
                        </h2>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                    </div>
                ...
                <!-- Small Default and Bordered Content Boxes -->
                <div class="row content-boxes-v2 margin-bottom-50">
                    <div class="col-md-4 md-margin-bottom-30">                
                        <h2 class="heading-sm">
                            <i class="icon-custom icon-sm icon-color-u fa fa-lightbulb-o"></i>
                            <span>Small Icons</span>
                        </h2>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                    </div>
                    <div class="col-md-4 md-margin-bottom-30">
                        <h2 class="heading-sm">
                            <i class="icon-custom icon-sm icon-color-blue fa fa-bullhorn"></i> 
                            <span>Small Icons</span>
                        </h2>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                    </div>
                    <div class="col-md-4">
                        <h2 class="heading-sm">
                            <i class="icon-custom icon-sm icon-color-red icon-line icon-rocket"></i>
                            <span>Small Icons</span>
                        </h2>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                    </div>
                </div>
                <!-- End Small Default and Bordered Content Boxes -->
                ...
                <div class="row content-boxes-v2 margin-bottom-30">
                    <div class="col-md-4 md-margin-bottom-30">                
                        <h2 class="heading-sm">
                            <i class="icon-custom rounded icon-bg-dark fa fa-lightbulb-o"></i>
                    ...
                    <div class="col-md-4 md-margin-bottom-30">
                        <h2 class="heading-sm">
                            <i class="icon-custom rounded icon-bg-dark fa fa-bullhorn"></i> 
                            <span>Default Icons</span>
                        </h2>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                    </div>
                    <div class="col-md-4">
                        <h2 class="heading-sm">
                            <i class="icon-custom rounded icon-bg-dark icon-line icon-rocket"></i>
                            <span>Default Icons</span>
                        </h2>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                    </div>
                </div>
                <!-- End Default Content Boxes -->

                <!-- Default Borderd Content Boxes -->
                <div class="row content-boxes-v2 margin-bottom-50">
                    <div class="col-md-4 md-margin-bottom-30">                
                        <h2 class="heading-sm">
                    ...
                    <div class="col-md-4 md-margin-bottom-30">
                        <h2 class="heading-sm">
                            <i class="icon-custom rounded icon-color-dark fa fa-bullhorn"></i> 
                            <span>Default Icons</span>
                        </h2>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                    </div>
                    <div class="col-md-4">
                        <h2 class="heading-sm">
                            <i class="icon-custom rounded icon-color-dark icon-line icon-rocket"></i>
                            <span>Default Icons</span>
                        </h2>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                    </div>
                </div>
                <!-- End Default Borderd Content Boxes -->
                ...
                <!-- Small Rounded and Bordered Content Boxes -->
                <div class="row content-boxes-v2 margin-bottom-50">
                    <div class="col-md-4 md-margin-bottom-30">                
                        <h2 class="heading-sm">
                ...
                <!-- End Small Rounded and Bordered Content Boxes -->
                ...
                <div class="row content-boxes-v2 margin-bottom-50">
                    ...
                    <div class="col-md-4 md-margin-bottom-30">
                        <h2 class="heading-sm">
                            <i class="icon-custom rounded-x icon-bg-dark fa fa-bullhorn"></i> 
                            <span>Default Icons</span>
                        </h2>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                    </div>
                ...
                <!-- Rounded and Bordered Content Boxes -->
                <div class="row content-boxes-v2 margin-bottom-50">
                    <div class="col-md-4 md-margin-bottom-30">                
                        <h2 class="heading-sm">
                            <i class="icon-custom rounded-x icon-color-dark fa fa-lightbulb-o"></i>
                            <span>Default Icons</span>
                        </h2>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                    </div>
                    ...
                    <div class="col-md-4">
                        <h2 class="heading-sm">
                            <i class="icon-custom rounded-x icon-color-dark icon-line icon-rocket"></i>
                            <span>Default Icons</span>
                        </h2>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                    </div>
                </div>
                <!-- End Rounded and Bordered Content Boxes -->
                ...
                <div class="tab-v1 margin-bottom-60">
                    <ul class="nav nav-tabs nav-justified margin-bottom-20">
                        <li class="active"><a href="#tab-1" data-toggle="tab">Default and Roudned Style</a></li>
                        <li><a href="#tab-2" data-toggle="tab">Rounded-2x and Circle</a></li>
                    </ul>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-1">
                            ...
                            <div class="row content-boxes-v1 margin-bottom-40">
                                <div class="col-md-4 md-margin-bottom-30">                
                                    <h2 class="heading-sm">
                                        <i class="icon-custom icon-lg icon-bg-u fa fa-lightbulb-o"></i>
                                ...
                                <div class="col-md-4 md-margin-bottom-30">
                                    <h2 class="heading-sm">
                                        <i class="icon-custom icon-lg icon-bg-blue fa fa-bullhorn"></i> 
                                        <span>Large Boxes</span>
                                    </h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                                </div>
                                <div class="col-md-4">
                                    <h2 class="heading-sm">
                                        <i class="icon-custom icon-lg icon-bg-red icon-line icon-rocket"></i>
                                        <span>Large Boxes</span>
                                    </h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                                </div>
                            ...
                            <div class="row content-boxes-v1">
                                <div class="col-md-4 md-margin-bottom-30">                
                                    <h2 class="heading-sm">
                                        <i class="icon-custom icon-lg icon-color-u fa fa-lightbulb-o"></i>
                                        <span>Bordered Boxes</span>
                                    </h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                                </div>
                                <div class="col-md-4 md-margin-bottom-30">
                                    <h2 class="heading-sm">
                                        <i class="icon-custom icon-lg icon-color-blue fa fa-bullhorn"></i> 
                                        <span>Bordered Boxes</span>
                                    </h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                                </div>
                                <div class="col-md-4">
                                    <h2 class="heading-sm">
                                        <i class="icon-custom icon-lg icon-color-red icon-line icon-rocket"></i>
                                        <span>Bordered Boxes</span>
                                    </h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                                </div>
                            ...
                            <div class="row content-boxes-v1 margin-bottom-40">
                                <div class="col-md-4 md-margin-bottom-30">                
                                    <h2 class="heading-md">
                                        <i class="icon-custom rounded icon-lg icon-bg-dark fa fa-lightbulb-o"></i>
                                        <span>Rounded Boxes</span>
                                    </h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                                </div>
                                <div class="col-md-4 md-margin-bottom-30">
                                    <h2 class="heading-md">
                                        <i class="icon-custom rounded icon-lg icon-bg-dark fa fa-bullhorn"></i> 
                                        <span>Rounded Boxes</span>
                                    </h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                                </div>
                                <div class="col-md-4">
                                    <h2 class="heading-md">
                                        <i class="icon-custom rounded icon-lg icon-bg-dark icon-line icon-rocket"></i>
                                        <span>Rounded Boxes</span>
                                    </h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                                </div>
                            ...
                            <!-- Rounded And Borderd Large Boxes -->
                            <div class="row content-boxes-v1">
                                <div class="col-md-4 md-margin-bottom-30">                
                                    <h2 class="heading-md">
                                        <i class="icon-custom rounded icon-lg icon-color-dark fa fa-lightbulb-o"></i>
                                        <span>Some Tittle Here</span>
                                    </h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                                </div>
                                <div class="col-md-4 md-margin-bottom-30">
                                    <h2 class="heading-md">
                                        <i class="icon-custom rounded icon-lg icon-color-dark fa fa-bullhorn"></i> 
                                        <span>Some Tittle Here</span>
                                    </h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                                </div>
                                <div class="col-md-4">
                                    <h2 class="heading-md">
                                        <i class="icon-custom rounded icon-lg icon-color-dark icon-line icon-rocket"></i>
                                        <span>Some Tittle Here</span>
                                    </h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                                </div>
                            </div>
                            <!-- End Rounded And Borderd Large Boxes -->
                        </div>
                        ...
                        <div class="tab-pane" id="tab-2">
                            ...
                            <div class="row content-boxes-v1 margin-bottom-40">
                                <div class="col-md-4 md-margin-bottom-30">                
                                    <h2 class="heading-sm">
                                        ...
                                        <span>Rounded-2x Boxes</span>
                                    </h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                                </div>
                                <div class="col-md-4 md-margin-bottom-30">
                                    <h2 class="heading-sm">
                                        <i class="icon-custom rounded-2x icon-lg icon-bg-blue fa fa-bullhorn"></i> 
                                        <span>Rounded-2x Boxes</span>
                                    </h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                                </div>
                                <div class="col-md-4">
                                    <h2 class="heading-sm">
                                        <i class="icon-custom rounded-2x icon-lg icon-bg-red icon-line icon-rocket"></i>
                                        <span>Rounded-2x Boxes</span>
                                    </h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                                </div>
                            </div>
                            <!-- End Default Large Boxes -->

                            <!-- Bordered Large Boxes -->
                            <div class="row content-boxes-v1">
                                <div class="col-md-4 md-margin-bottom-30">                
                                    <h2 class="heading-sm">
                                        <i class="icon-custom rounded-2x icon-lg icon-color-u fa fa-lightbulb-o"></i>
                                        <span>Bordered-2x Boxes</span>
                                    </h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                                </div>
                                <div class="col-md-4 md-margin-bottom-30">
                                    <h2 class="heading-sm">
                                        <i class="icon-custom rounded-2x icon-lg icon-color-blue fa fa-bullhorn"></i> 
                                        <span>Bordered-2x Boxes</span>
                                    </h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                                </div>
                                <div class="col-md-4">
                                    <h2 class="heading-sm">
                                        <i class="icon-custom rounded-2x icon-lg icon-color-red icon-line icon-rocket"></i>
                                        <span>Bordered-2x Boxes</span>
                                    </h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                                </div>
                            ...
                            <div class="row content-boxes-v1 margin-bottom-40">
                                <div class="col-md-4 md-margin-bottom-30">                
                                    <h2 class="heading-md">
                                        <i class="icon-custom rounded-x icon-lg icon-bg-dark fa fa-lightbulb-o"></i>
                                ...
                                <div class="col-md-4 md-margin-bottom-30">
                                    <h2 class="heading-md">
                                        <i class="icon-custom rounded-x icon-lg icon-bg-dark fa fa-bullhorn"></i> 
                                        <span>Circle Style</span>
                                    </h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                                </div>
                                <div class="col-md-4">
                                    <h2 class="heading-md">
                                        <i class="icon-custom rounded-x icon-lg icon-bg-dark icon-line icon-rocket"></i>
                                        <span>Circle Style</span>
                                    </h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                                </div>
                            ...
                            <div class="row content-boxes-v1">
                                <div class="col-md-4 md-margin-bottom-30">                
                                    <h2 class="heading-md">
                                        <i class="icon-custom rounded-x icon-lg icon-color-dark fa fa-lightbulb-o"></i>
                                        <span>Circle Style</span>
                                    </h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                                </div>
                                <div class="col-md-4 md-margin-bottom-30">
                                    <h2 class="heading-md">
                                        <i class="icon-custom rounded-x icon-lg icon-color-dark fa fa-bullhorn"></i> 
                                        <span>Circle Style</span>
                                    </h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                                </div>
                                <div class="col-md-4">
                                    <h2 class="heading-md">
                                        <i class="icon-custom rounded-x icon-lg icon-color-dark icon-line icon-rocket"></i>
                                        <span>Circle Style</span>
                                    </h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                                </div>
                            </div>
                            <!-- End Cirlce Large Boxes -->
                        </div>
                    </div>
                </div>
                <!-- End Large Content Boxes -->
                ...
                <!-- Default Rounded and Borderd Boxes -->
                <div class="row content-boxes-v1 margin-bottom-30">
                    <div class="col-md-4 md-margin-bottom-30">                
                        <h2 class="heading-sm">
                            <i class="icon-custom rounded icon-color-dark fa fa-lightbulb-o"></i>
                ...
                <!-- End Default Rounded and Borderd Boxes -->
                ...
                <div class="row content-boxes-v1 margin-bottom-30">
                    <div class="col-md-4 md-margin-bottom-30">                
                        <h2 class="heading-sm">
                            <i class="icon-custom icon-sm rounded-x icon-bg-u fa fa-lightbulb-o"></i>
                            <span>Small Icons</span>
                        </h2>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                    </div>
                    <div class="col-md-4 md-margin-bottom-30">
                        <h2 class="heading-sm">
                            <i class="icon-custom icon-sm rounded-x icon-bg-blue fa fa-bullhorn"></i>
                            <span>Small Icons</span>
                        </h2>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                    </div>
                    <div class="col-md-4">
                        <h2 class="heading-sm">
                            <i class="icon-custom icon-sm rounded-x icon-bg-red icon-line icon-rocket"></i>
                            <span>Small Icons</span>
                        </h2>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                    </div>
                ...
                <!-- Small Rounded Circle Content Boxes -->
                <div class="row content-boxes-v1 margin-bottom-40">
                    <div class="col-md-4 md-margin-bottom-30">                
                        <h2 class="heading-sm">
                            <i class="icon-custom icon-sm rounded-x icon-color-u fa fa-lightbulb-o"></i>
                            <span>Small Icons</span>
                        </h2>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                    </div>
                    <div class="col-md-4 md-margin-bottom-30">
                        <h2 class="heading-sm">
                            <i class="icon-custom icon-sm rounded-x icon-color-blue fa fa-bullhorn"></i> 
                            <span>Small Icons</span>
                        </h2>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                    </div>
                    <div class="col-md-4">
                        <h2 class="heading-sm">
                            <i class="icon-custom icon-sm rounded-x icon-color-red icon-line icon-rocket"></i>
                            <span>Small Icons</span>
                        </h2>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                    </div>
                ...
                <!-- Default Circle Content Boxes -->
                <div class="row content-boxes-v1 margin-bottom-30">
                    <div class="col-md-4 md-margin-bottom-30">                
                        <h2 class="heading-sm">
                            <i class="icon-custom rounded-x icon-bg-dark fa fa-lightbulb-o"></i>
                            <span>Default Circle Icons</span>
                        </h2>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                    </div>
                    <div class="col-md-4 md-margin-bottom-30">
                ...
                <!-- End Default Circle Content Boxes -->
