        ...
        <div class="topbar">
            <div class="container">
                ...
                <ul class="loginbar pull-right">
                    @if (Auth::check())
                        <li><a href="{{ URL::to('my_account/info') }}"><span aria-hidden="true" class="icon-user"></span> {{ Auth::user()->user_fullname }}</a></li>
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="{{ URL::to('performance/home') }}">
                        <img id="logo-header" src="{{ URL::to('assets/img/airbus_blue_3d.png') }}" alt="Logo">
                    </a>
                </div>
