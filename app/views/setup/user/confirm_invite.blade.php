    ...
    <div class="col-md-10">
        ...
        <div class="table-search-v1 panel panel-grey">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-user"></i> User Update</h3>
            </div>
            <!-- Form -->
            {{ Form::open(array('action' => array('UserController@confirmInvite', $data['user']->user_key), 'class' => 'sky-form', 'id' => 'form', 'files' => true, 'method' => 'POST')) }}
                <div class="tab-v2">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade in active" id="tab-profile">
                                ...
                                <div class="row">
                                    <section class="col col-4">
                                        ...
                                        <label class="input @if ($errors->has('user_birth_date')) state-error @endif">
                                            ...
                                            <input type="text" name="user_birth_date" value="{{ (Input::old('user_birth_date') || $data['user']->user_birth_date == $shareView['invalid_date']) ? Input::old('user_birth_date') : \Carbon\Carbon::createFromFormat(DB_DATE_FORMAT, $data['user']->user_birth_date)->format(DATE_FORMAT_1); }}" class="date">
                                    ...
                                    <section class="col col-4">
                                        ...
                                        <label class="input @if ($errors->has('user_left_date')) state-error @endif">
                                            <i class="icon-append fa fa-calendar"></i>
                                            <input type="text" name="user_left_date" value="{{ (Input::old('user_left_date')) ? Input::old('user_left_date') : $data['user']->user_left_date }}" class="date_month_year">
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <section class="col col-3"><label class="label"><i class="fa fa-asterisk"></i> Pasword</label></section>
                                    <section class="col col-5">
                                                ...
                                                <select id="country_key{{ $j }}" name="country_key{{ $j }}" class="input_country_key{{ $j }}">
                                                    <option value="" selected>--- select ---</option>
                                                     @foreach ($data["countries"] as $country)
                                                        ...
                                                        @elseif (Input::old('country_key' . $j) == "" && isset($record->Country->country_key) && $record->Country->country_key == $country->country_key)
                                                            <option value="{{ $country->country_key }}" selected>{{ $country->country_call }}</option>
                                                        @else
            ...
            <div class="margin-bottom-40">
                {{ Form::open(array('action' => array('UserContactController@deleteContact'), 'id' => 'form_delete', 'method' => 'POST')) }}
                        ...
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn-u" id="modal_btn_yes"><i class="fa fa-thumbs-up"></i> Yes</button>
                                </div>
                            </div>
                        </div>
                    </div>
