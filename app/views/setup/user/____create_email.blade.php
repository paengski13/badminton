...
<html lang="en">
    <head>
        <title>Airbus Helicopters Southeast Asia Pte. Ltd</title>
                                            ...
                                            <table  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                                                <tr>
                                                    <td class="center" style="padding: 10px 0px 10px 0px">
                                                        <a href="#"><img src="{{ URL::to('assets/img/airbus_blue_3d.png') }}"></a>
                                                    </td>
                                                </tr>
                                            </table><!--End logo-->
                                            <!--Start nav-->
                    ...
                    <table width="700" border="0" cellpadding="0" cellspacing="0" align="center" class="deviceWidth">
                        <tr>
                            <td valign="top" style="padding: 0px " class="center">
                                <a href="#"><img class="deviceWidth" src="{{ URL::to('assets/img/email_template/headliner/headliner_red.jpg') }}"></a>
                            </td>
                        </tr>
                    </table>
                    <!-- Start Headliner-->
                                            ...
                                            <table  border="0" cellpadding="0" cellspacing="0" align="center" > 
                                                <tr>
                                                    <td valign="top" style="padding: 20px 0px " class="center">
                                                        <a href="#"><img width="45" hight="45" src="{{ URL::to('assets/img/email_template/icons/icon_layers_red.png') }}"></a>
                                                    </td>
                                                </tr>
                                            </table>
                                            <table  border="0" cellpadding="0" cellspacing="0" align="center"> 
                                                ...
                                                <tr>
                                                    <td  class="center" style="font-size: 12px; color: #687074; font-weight: bold; text-align: center; font-family: Arial, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 20px 10px; " >
                                                        Game of as rest time eyes with of this it. Add was music merry any truth since going. Happiness she ham but instantly put departure propriety.                           
                                                   </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="center">
                                            <table  border="0" cellpadding="0" cellspacing="0" align="center"> 
                                                <tr>
                                                    <td valign="top" style="padding: 20px 0px " class="center">
                                                        <a href="#"><img width="45" hight="45" src="{{ URL::to('assets/img/email_template/icons/icon_plane_red.png') }}"></a>
                                                    </td>
                                                </tr>
                                            </table>
                                            <table  border="0" cellpadding="0" cellspacing="0" align="center"> 
                                                <tr>
                                                    <td  class="center" style="font-size: 16px; color: #303030; font-weight: bold; text-align: center; font-family: Arial, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 0px 10px; ">
                                                         Email Client Friedly                             
                                                   </td>
                                                </tr>
                                                <tr>
                                                    <td  class="center" style="font-size: 12px; color: #687074; font-weight: bold; text-align: center; font-family: Arial, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 20px 10px; " >
                                                        Arrival entered an if drawing request. How daughters not promotion few knowledge contented. Yet winter law behind number                           
                                                   </td>
                                                </tr>
                                            </table>
                                        </td>
                               ...
                               <table width="40%"  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                                    <tr>
                                        <td valign="top" style="padding: 40px 20px " class="center">
                                            <a href="#"><img width="300" hight="170" src="{{ URL::to('assets/img/email_template/block_img/picture1.jpg') }}"></a>
                                        </td>
                                    </tr>
                                     <tr>
                                    ...
                                    <tr>
                                        <td  class="center" style="font-size: 12px; color: #687074; font-weight: bold; text-align: center; font-family: Arial, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 20px 10px; " >
                                            Arrival entered an if drawing requests iness not promotion few knowledge. contented. Yet winter law  romotion few knowledge contented behind 
                                        </td>
                                    </tr>
                                </table> <!--End left box--> 
                                 <!-- Left box  -->
                                <table width="40%"  border="0" cellpadding="0" cellspacing="0" align="right" class="deviceWidth">
                                    <tr>
                                        <td valign="top" style="padding: 40px 20px " class="center">
                                            <a href="#"><img width="300" hight="170" src="{{ URL::to('assets/img/email_template/block_img/picture2.jpg') }}"></a>
                                        </td>
                                    </tr>
                                     <tr>
                                        <td  class="center" style="font-size: 16px; color: #303030; font-weight: bold; text-align: center; font-family: Arial, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 0px 10px;">
                                            ...
                                            <table  border="0" cellpadding="0" cellspacing="0" align="center"> 
                                                <tr>
                                                    <td  class="center" style="font-size: 16px; color: #687074; font-weight: bold; text-align: center; font-family: Arial, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 20px 10px 10px;">
                                                        Uprade your plan today and Get 50% Discount                            
                                                   </td>
                                                </tr>
                                            </table>
                                        </td>
                                ...
                                <table width="30%"  border="0" cellpadding="0" cellspacing="0" align="center" class="deviceWidth">
                                    <tr>
                                        <td style=" padding: 15px 20px 30px;">
                                                <table  align="center">
                                                    <tr>
                                                        <td  valign="top" style="padding: 7px 15px; text-align: center; background-color: #e74c3c;" class="center">
                                                            <a style="color: #fff; font-size: 12px; font-weight: bold; text-decoration: none; font-family: Arial, sans-serif; text-alight: center;" href="#">VIEW MORE</a>
                                                        </td>                                   
                                                     </tr>
                                                </table>
                                            </td>
                                ...
                                <table width="70%"  border="0" cellpadding="0" cellspacing="0" align="center" > 
                                    ...
                                    <tr>
                                        <td width="50%" class="center" style="font-size: 12px; color: #687074; font-weight: bold; text-align: center; font-family: Arial, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 20px 10px; " >
                                             Par of as rest time eyes with of this it. Add was music merry any truth since going. Happiness she ham but instantly put departure propriety as rest time eyes with of this it sail was music.                           
                                        </td>
                                    </tr>
                                </table><!--End Top-->
                            </td>
                                ...
                                <tr>
                                    <td width="100%" bgcolor="#f7f7f7"> 
                                        ...
                                        <table width="33%"  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                                            <tr>
                                                <td valign="top" style="padding: 20px 30px " class="center">
                                                    <a href="#"><img width="144" hight="144" src="{{ URL::to('assets/img/email_template/brands/natural.png') }}"></a>
                                                </td>
                                            </tr>
                                        </table><!--End Image 1-->
                                        <!--Start Image 2-->
                                        <table width="33%"  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                                            <tr>
                                                <td valign="top" style="padding: 20px 30px " class="center">
                                                    <a href="#"><img width="144" hight="144" src="{{ URL::to('assets/img/email_template/brands/everyday.png') }}"></a>
                                                </td>
                                            </tr>
                                        </table><!--End Image 2-->    
                                        <!--Start Image 3-->
                                        <table width="33%"  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                                            <tr>
                                                <td valign="top" style="padding: 20px 30px " class="center">
                                                    <a href="#"><img width="144" hight="144" src="{{ URL::to('assets/img/email_template/brands/gamescast.png') }}"></a>
                                                </td>
                                            </tr>
                                        </table><!--End Image 3-->
                                    </td>     
                                ...
                                <tr>
                                    <td width="100%" bgcolor="#f7f7f7">
                                        ...
                                        <table width="33%"  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                                            <tr>
                                                <td valign="top" style="padding: 20px 30px " class="center">
                                                    <a href="#"><img width="144" hight="144" src="{{ URL::to('assets/img/email_template/brands/cisco.png') }}"></a>
                                                </td>
                                            </tr>
                                        </table><!--End Image 1-->
                                        <!--Start Image 2-->
                                        <table width="33%"  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                                            <tr>
                                                <td valign="top" style="padding: 20px 30px " class="center">
                                                    <a href="#"><img width="144" hight="144" src="{{ URL::to('assets/img/email_template/brands/spinworkx.png') }}"></a>
                                                </td>
                                            </tr>
                                        </table><!--End Image 2-->    
                                        <!--Start Image 3-->
                                        <table width="33%"  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                                            <tr>
                                                <td valign="top" style="padding: 20px 30px " class="center">
                                                    <a href="#"><img width="144" hight="144" src="{{ URL::to('assets/img/email_template/brands/walmart.png') }}"></a>
                                                </td>
                                            </tr>
                                        </table><!--End Image 3 -->
                                    </td>     
                                ...
                                <table  border="0" cellpadding="0" cellspacing="0" align="center"> 
                                    <tr>
                                        <td valign="top" style="padding: 20px 10px " class="center">
                                            <a href="#"><img width="32" hight="32" src="{{ URL::to('assets/img/email_template/icons/icon_facebook.png') }}"></a>
                                        </td>
                                        <td valign="top" style="padding: 20px 10px " class="center">
                                            <a href="#"><img width="32" hight="32" src="{{ URL::to('assets/img/email_template/icons/icon_twitter.png') }}"></a>
                                        </td>
                                        <td valign="top" style="padding: 20px 10px " class="center">
                                            <a href="#"><img width="32" hight="32" src="{{ URL::to('assets/img/email_template/icons/icon_youtube.png') }}"></a>
                                        </td>
                                    </tr>
                                </table>
                                <table  border="0" cellpadding="0" cellspacing="0" align="center"> 
                    ...
                    <table width="700"  border="0" cellpadding="0" cellspacing="0" align="center" class="deviceWidth"  > 
                        ...
                        <tr>
                            <td  bgcolor="#ffffff" class="center" style="font-size: 12px; color: #687074; font-weight: bold; text-align: center; font-family: Arial, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 20px 0px 0px; " >
                                 Drawings me opinions returned absolute in. Otherwise therefore did are unfeeling something. Certain be ye amiable by exposed Two differed husbands met screened his. Bed was form wife out ask draw. Wholly coming at we no enable                           
                            </td>
                        </tr>
                          ...
                          <tr>
                            <td  bgcolor="#ffffff" class="center" style="font-size: 12px; color: #687074; font-weight: bold; text-align: center; font-family: Arial, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 20px 10px; " >
                                 If you would prefer not to receive email communications from Unify Template click <a style="text-decoration: none; color: #e74c3c;" href="#">here</a>  
                            </td>
                        </tr>
                    </table>
                    <!--End Footer-->
