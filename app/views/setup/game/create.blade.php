    ...
    <div class="col-md-10">
        ...
        <div class="table-search-v1 panel panel-grey">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-gamepad"></i> Game Add</h3>
            </div>
            <!-- Form -->
            {{ Form::open(array('action' => 'game.store', 'class' => 'sky-form')) }}
                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <section class="col col-7">
                            <label class="input @if ($errors->has('game_name')) state-error @endif">
                                ...
                                <input type="text" name="game_name" value="{{ Input::old('game_name') }}">
                    ...
                    <div class="row">
                        ...
                        <section class="col col-3">
                            <label class="input @if ($errors->has('game_date')) state-error @endif">
                                ...
                                <input type="text" name="game_date" value="{{ Input::old('game_date') }}" class="date">
                    ...
                    <div class="row">
                        <section class="col col-3"><label class="label"><i class="fa fa-asterisk"></i> From Time</label></section>
                        <section class="col col-3">
                            <label class="input @if ($errors->has('game_time_from')) state-error @endif">
                                <i class="icon-append fa fa-calendar"></i>
                                <input type="text" name="game_time_from" value="{{ Input::old('game_time_from') }}" class="hour_minute">
                                {{ $errors->first('game_time_from', '<em for="game_time_from" class="invalid error-msg">:message</em>') }}
                            </label>
                        </section>
                        <section class="col col-1"></section>
                        <section class="col col-2"><label class="label"><i class="fa fa-asterisk"></i> To Time</label></section>
                        <section class="col col-3">
                            <label class="input @if ($errors->has('game_time_to')) state-error @endif">
                                <i class="icon-append fa fa-calendar"></i>
                                <input type="text" name="game_time_to" value="{{ Input::old('game_time_to') }}" class="hour_minute">
                                {{ $errors->first('game_time_to', '<em for="game_time_to" class="invalid error-msg">:message</em>') }}
                            </label>
                        </section>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <section class="col col-3">
                            <label class="input @if ($errors->has('game_max_players')) state-error @endif">
                                ...
                                <input type="text" name="game_max_players" value="{{ Input::old('game_max_players') }}">
                    ...
                    <div class="row">
                        ...
                        <section class="col col-9">
                            <label class="textarea @if ($errors->has('game_remarks')) state-error @endif">
                                ...
                                <textarea rows="4" name="game_remarks">{{ Input::old('game_remarks') }}</textarea>
                    ...
                    <div class="row">
                        ...
                        <section class="col col-3">
                            <label class="input @if ($errors->has('game_amount')) state-error @endif">
                                ...
                                <input type="text" name="game_amount" value="{{ Input::old('game_amount') }}">
                    ...
                    <div class="row">
                        ...
                        <section class="col col-3">
                            <label class="input @if ($errors->has('game_debt_amount')) state-error @endif">
                                <i class="icon-append fa fa-dollar"></i>
                                <input type="text" name="game_debt_amount" value="{{ Input::old('game_debt_amount') }}">
                    ...
                    <div class="row">
                        ...
                        <section class="col col-3">
                            <label class="input @if ($errors->has('game_announce_date')) state-error @endif">
                                <i class="icon-append fa fa-calendar"></i>
                                <input type="text" name="game_announce_date" value="{{ Input::old('game_announce_date') }}" class="date">
                    ...
                    <div class="row">
                        ...
                        <section class="col col-3">
                            <label class="input @if ($errors->has('game_announce_final_date')) state-error @endif">
                                <i class="icon-append fa fa-calendar"></i>
                                <input type="text" name="game_announce_final_date" value="{{ Input::old('game_announce_final_date') }}" class="date">
                            ...
                            <label class="select @if ($errors->has('game_status')) state-error @endif">
                                <select name="game_status">
                                    @foreach ($data["status"] as $key => $value)
                                        ...
                                        @elseif (Input::old('game_status') == "" && $key == 'A')
                                            <option value="{{ $key }}" selected>{{ $value }}</option>
                                        @else
