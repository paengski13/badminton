    ...
    <div class="col-md-10">
        ...
        <div class="table-search-v1 panel panel-grey">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-trophy"></i> Tournament Add</h3>
            </div>
            <!-- Form -->
            {{ Form::open(array('action' => 'tournament.store', 'class' => 'sky-form')) }}
                    ...
                    <div class="row">
                        ...
                        <section class="col col-5">
                            <label class="input @if ($errors->has('tournament_name')) state-error @endif">
                                ...
                                <input type="text" name="tournament_name" value="{{ Input::old('tournament_name') }}">
                    ...
                    <div class="row">
                        ...
                        <section class="col col-10">
                            <label class="textarea @if ($errors->has('tournament_description')) state-error @endif">
                                ...
                                <textarea rows="4" name="tournament_description">{{ Input::old('tournament_description') }}</textarea>
                    ...
                    <div class="row">
                        ...
                        <section class="col col-10">
                            <label class="input @if ($errors->has('tournament_organizer')) state-error @endif">
                                ...
                                <input type="text" name="tournament_organizer" value="{{ Input::old('tournament_organizer') }}">
                    ...
                    <div class="row">
                        ...
                        <section class="col col-3">
                            <label class="input @if ($errors->has('tournament_date_from')) state-error @endif">
                                ...
                                <input type="text" name="tournament_date_from" value="{{ Input::old('tournament_date_from') }}" class="date">
                        ...
                        <section class="col col-3">
                            <label class="input @if ($errors->has('tournament_date_to')) state-error @endif">
                                <i class="icon-append fa fa-calendar"></i>
                                <input type="text" name="tournament_date_to" value="{{ Input::old('tournament_date_to') }}" class="date">
                    ...
                    <div class="row">
                        ...
                        <section class="col col-10">
                            <label class="input @if ($errors->has('tournament_location')) state-error @endif">
                                ...
                                <input type="text" name="tournament_location" value="{{ Input::old('tournament_location') }}">
                    ...
                    <div class="row">
                        ...
                        <section class="col col-10">
                            <label class="textarea @if ($errors->has('tournament_remarks')) state-error @endif">
                                <i class="icon-append fa fa-comment"></i>
                                <textarea rows="4" name="tournament_remarks">{{ Input::old('tournament_remarks') }}</textarea>
                            ...
                            <label class="select @if ($errors->has('tournament_status')) state-error @endif">
                                <select name="tournament_status">
                                    @foreach ($data["status"] as $key => $value)
                                        ...
                                        @elseif (Input::old('tournament_status') == "" && $key == 'A')
                                            <option value="{{ $key }}" selected>{{ $value }}</option>
                                        @else
